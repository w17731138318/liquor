  ...
  <div class="mod-config">
    <el-form :inline="true" size="mini" :model="dataForm" @keyup.enter.native="getDataList()">
      ...
      <el-form-item>
        ...
        <el-button size="mini" v-if="isAuth('web:theme:save')" type="primary" @click="addOrUpdateHandle()">新增</el-button>
        <el-button size="mini" v-if="isAuth('web:theme:delete')" type="danger" @click="deleteHandle()" :disabled="dataListSelections.length <= 0">批量删除</el-button>
      </el-form-item>
    </el-form>
    <el-table
      size="mini"
  ...
  export default {
    ...
    methods: {
      ...
      getDataList () {
        ...
        API.theme.list(params).then(({data}) => {
          if (data && data.code === 0) {

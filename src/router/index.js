...
export default new Router({
  ...
  routes: [
    ...
    { path: '/nfc/:nfcCode', component: _import('nfc/index'), name: 'nfc', desc: 'nfc' },
    { path: '/info/:nfcCode', component: _import('info/index'), name: 'info', desc: 'info' },
    {
      path: '/',
      ...
      children: [
        { path: '/home', component: _import('home/index'), name: 'home', desc: '首页' },
        {
          ...
          children: [
            ...
            { path: '/n/goods', component: _import('goods/index'), name: 'goods', desc: '货物管理' },
            { path: '/n/bottle', component: _import('bottle/index'), name: 'bottle', desc: 'NFC列表' }
          ]
        }
      ],
